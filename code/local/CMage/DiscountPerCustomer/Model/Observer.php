<?php
class CMage_DiscountPerCustomer_Model_Observer {
    ...
    public function setDiscount($observer) {
        ...
        if(Mage::getSingleton('customer/session')->isLoggedIn()) {
            ...
            $attrValue = $customerObj->getData('customer_discount');

            $thetotal = $quote->getBaseSubtotal();

            if(!empty($attrValue) && $attrValue > $discountAmount && $attrValue < $thetotal){
                $discountAmount = $attrValue;
            }
        }
